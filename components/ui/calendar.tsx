  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "inline-flex items-center justify-center rounded-md border border-input bg-transparent hover:bg-accent hover:text-accent-foreground",
        ...
        day_range_middle:
          "aria-selected:bg-primary/20 aria-selected:text-foreground hover:bg-primary/20 hover:text-foreground rounded-none",
